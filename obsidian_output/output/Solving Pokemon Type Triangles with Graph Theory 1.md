...
![](attachment/5f80e904bd114ccbc0591b09fafb4878.png)
...
(`(Damage done by X1 on {Y1,Y2}) + (Damage done by X2 on {Y1,Y2})`)/2. 
...
Consider the `Water > Fire > Grass` triangle. Each type hits the next one for **2x** damage, while taking only **0.5x** in return. That means every edge in the triangle has the same level of asymmetry, i.e.
...
- **Offensive balance** means:$$W(A,B) \approx W(B,C) \approx W(C,A)$$
- **Defensive balance** means:$$W(B,A) \approx W(A,C) \approx W(C,B)$$
...
![](attachment/5d8240f7388cc59ab7d0666c5d92adff.png)
### Score : 0.0
...
![](attachment/ed96ea35c3f4dd967e01fb90191ecec1.png)
### Score : 0.0
...
![](attachment/037956a85354b4870c0d62393e88fd17.png)
...
![](attachment/df14fd6d7f4daf5367187593fb49e068.png)

## Score : 0.00347

Dark appears twice here, yet the triangle remains balanced. I'm not rating this as highly as the others, as it's not as diverse. -->